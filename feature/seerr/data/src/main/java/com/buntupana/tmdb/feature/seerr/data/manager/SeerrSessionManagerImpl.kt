package com.buntupana.tmdb.feature.seerr.data.manager
...
class SeerrSessionManagerImpl(
    ...
    override val session: StateFlow<SeerrSession> = runBlocking {
    ...
    override suspend fun saveSession(session: SeerrSession) {
